...
class EvoSAP_AES(EvoSAP):
    """ EvoSAP Class which counts fitness evaluations. """
...
class EvoSAP_1(EvoSAP_AES):
    """ EvoSAP mutation method one (Randomly). """
...
class EvoSAP_2(EvoSAP_AES):
    """ EvoSAP mutation method two (Partial flip). """
...
class EvoSAP_3(EvoSAP_AES):
    """ EvoSAP mutation method three (Forced Positive). """
