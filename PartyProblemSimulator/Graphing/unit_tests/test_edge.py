...
class TestEdge(TestCase):
    ...
    @patch('PartyProblemSimulator.Graphing.Edge.Edge._set_origin')
    @patch('PartyProblemSimulator.Graphing.Edge.Edge._set_target')
    @patch('PartyProblemSimulator.Graphing.Edge.Edge.set_colour')
