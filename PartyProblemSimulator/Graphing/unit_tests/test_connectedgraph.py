...
class TestConnectedGraph(TestCase):
    ...
    @patch('PartyProblemSimulator.Graphing.ConnectedGraph.ConnectedGraph._generate_vertices')
    @patch('PartyProblemSimulator.Graphing.ConnectedGraph.ConnectedGraph._generate_edges')
    ...
    @patch('PartyProblemSimulator.Graphing.ConnectedGraph.Edge')
    @patch('PartyProblemSimulator.Graphing.ConnectedGraph.ConnectedGraph._generate_vertices')
