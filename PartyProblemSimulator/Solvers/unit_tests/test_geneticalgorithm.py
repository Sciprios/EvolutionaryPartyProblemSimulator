...
class TestGeneticAlgorithm(TestCase):
    ...
    @patch('PartyProblemSimulator.Solvers.GeneticAlgorithm.GeneticAlgorithm._set_equation')
    ...
    def test_init(self, repop, set_gen, set_eq, set_genome, set_max):
        ...
        set_eq.assert_called_with(None)
